    ...
    <div className="flex justify-center gap-20 mt-20 items-center flex-col mb-20 text-center">
      ...
      <div className="flex flex-col max-w-lg">
        ...
        <h3 className="mt-4 text-gray-500 px-10 md:px-0">
          I am <span className="text-violet-600">Ayush Meena</span> , a developer who specializes in creating high-performance applications using the latest Tech Stack.
        </h3>
      </div>
